...
class MidlevelAgent(AbstractDataCollector):
    ...
    def compute_obstacle_constraints_GMM(
        ...
        truck_d = truck['d']
        CAR_R = 4.47213 #self.__params.diag
        ...
        return GMMconstraints, vertices, A_union, b_union, OVconstraint
    ...
    def __compute_prediction_controls(self, frame, Tsh):
        ...
        try:
            ...
            raise Exception(f"Unknown reason.")
