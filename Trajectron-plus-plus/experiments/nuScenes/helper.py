...
car_paths = [
        os.path.join(os.path.dirname(__file__), 'icons/Car TOP_VIEW 375397.png'),
        os.path.join(os.path.dirname(__file__), 'icons/Car TOP_VIEW F05F78.png'),
        os.path.join(os.path.dirname(__file__), 'icons/Car TOP_VIEW 80CBE5.png'),
        os.path.join(os.path.dirname(__file__), 'icons/Car TOP_VIEW ABCB51.png'),
        os.path.join(os.path.dirname(__file__), 'icons/Car TOP_VIEW C8B0B0.png'),]
cars = [plt.imread(path) for path in car_paths]

robot_path = os.path.join(os.path.dirname(__file__), 'icons/Car TOP_VIEW ROBOT.png')
robot = plt.imread(robot_path)
