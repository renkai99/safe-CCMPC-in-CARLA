...
#SBATCH --job-name=train_carla_v2_1_dynmap_K6
...
python train.py \
    ...
    --eval_every 1 \
    --vis_every 1 \
    --conf int_ee_me.ph8.K6.config.json \
    --train_data_dict carla_train_v2_1_full.pkl \
    --eval_data_dict carla_val_v2_1_full.pkl \
