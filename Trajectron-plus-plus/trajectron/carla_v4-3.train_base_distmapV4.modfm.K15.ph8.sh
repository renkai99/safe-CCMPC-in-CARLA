...
#SBATCH --job-name=carla_v4-3.train_base_distmapV4.modfm.K15.ph8
#SBATCH --output=/scratch/cchen795/2/slurm/%x-%j.out
#SBATCH --error=/scratch/cchen795/2/slurm/%x-%j.out
