...
#SBATCH --job-name=carla_v3-1-2.train_base_distmapV4_modfm.K20.ph8
...
python train.py \
	...
	--eval_every 1 \
	--vis_every 1 \
	--conf base_distmapV4-1.K20.ph8.json \
	...
	--log_tag _carla_${DATA_VER}_base_distmapV4_modfm_K20_ph8 \
	--map_encoding \
	--augment \
